export const messages = {
  ...
  spontaneousAbsenceAddedEndDate:
    'Your boss has added an end date for your absence',
  spontaneousAbsenceDecisionMade:
    'A decision has been taken on your unjustified absence',
};
