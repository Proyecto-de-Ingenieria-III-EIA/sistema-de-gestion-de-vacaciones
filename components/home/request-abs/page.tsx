...
const formSchema = z
  ...
  .refine((d) => d.endDate >= d.startDate, {
    path: ['endDate'],
    message: 'La fecha de fin debe ser posterior o igual',
  });
...
export default function RequestAbsencePage() {
  ...
  /* mutaciones */
  const [createRequestedAbsence] = useMutation(
    CREATE_REQUESTED_ABSENCE_FOR_POST,
    {
      refetchQueries: ['GetPendingRequestedAbsences'],
    }
  );
  const [createSpontaneousAbsence] = useMutation(
    CREATE_SPONTANEOUS_ABSENCE_FOR_POST,
    {
      refetchQueries: ['GetPendingRequestedAbsences'],
    }
      ...
      <div className='max-w-2xl mx-auto'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Completa el formulario y será enviado para aprobación.
            </CardDescription>
          </CardHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Colaborador</FormLabel>
                        <Input
                          value={meData?.getCurrentUser?.name ?? ''}
                          disabled
                        />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Puedes adjuntar imagen, video o PDF.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
