...
//           <div>
//             <h3 className="font-medium text-lg mb-4">Los Arturos</h3>
//             <p className="text-gray-600 text-sm mb-4">
//               Simplifying absence management with elegant solutions.
//             </p>
...
//             <ul className="space-y-2 text-sm text-gray-600">
//               <li>
//                 <a href="mailto:contact@losarturos.com" className="hover:text-black transition-colors">
//                   contact@losarturos.com
//                 </a>
//               </li>
//               <li>
